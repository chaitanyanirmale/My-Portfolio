    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20" >
      <div className="max-w-5xl mx-auto text-center">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <p className="text-amber-600 font-medium mb-4">Hello, I'm</p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >View Projects</a>
            <a href="#contact"className="px-6 py-3 rounded-lg border border-gray-300                        text-gray-700 font-medium hover:bg-gray-100 transition"
            >Contact Me</a>
          </div>
        </motion.div>
      </div>
